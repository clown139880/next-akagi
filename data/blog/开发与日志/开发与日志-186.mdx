---
postId: 186
title: "从 Heroku 迁移 Rails 应用到 GCP"
date: '2017-11-08 20:25:53'
lastmod: '2020-02-05 03:40:48'
tags: ["Rails", "GCP", "部署", "开发"]
draft: false
summary: "记录一次完整的服务器迁移：将 Rails 应用从 Heroku 搬到 Google Cloud，并把 PostgreSQL 数据转入 MySQL，处理部署、数据库、Nginx 与服务配置中遇到的问题。"
images: []
authors: ['default']
---
